#!/usr/bin/env python3
"""
Run predefined trajectories from JSON files in AirSim
Usage: python run_trajectory.py trajectories/straight_line.json
"""
...
def main():
    """Main execution"""
    if len(sys.argv) < 2:
        print("Usage: python run_trajectory.py <trajectory_json_file>")
    ...
    try:
        ...
        input("\nPress ENTER to start trajectory (make sure Unreal is running)...")
